...
module.exports = async function () {
  ...
  try {
    ...
    console.warn(`[afterword] albumwhale feed unavailable: ${error.message}`);
    return [];
  }
  ...
  if (needsScrape) {
    try {
      listHtml = await getListPageHtml();
    } catch (error) {
      console.warn(`[afterword] albumwhale list page unavailable: ${error.message}`);
    }
  }
